...
class LinkController extends AdminbaseController{
	...
	function edit(){
		...
		$str=	"<option". $a ."value='1'>首页Banner-a</option>".
				"<option". $a ."value='8'>首页Banner-b</option>".
				"<option". $a ."value='9'>首页Banner-c</option>".
				"<option". $b ."value='2'>发单Banner</option>".
				"<option". $c ."value='3'>接单Banner</option>".
