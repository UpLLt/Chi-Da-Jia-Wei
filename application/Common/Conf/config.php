...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Notify','Coupon','AdOwn','Admin','Portal','Repair','Asset','Lianbao_PC','Api','User','Wx','Comment','Own','Tpl','Topic','Install','Bug','Better','Pay','Cas'),
        'TMPL_DETECT_THEME'     => false,       // 自动侦测模板主题
        'TMPL_TEMPLATE_SUFFIX'  => '.html',     // 默认模板文件后缀
        'DEFAULT_MODULE'        =>  'Lianbao_PC',  // 默认模块
